...
<Callout type="info" emoji="ℹ️">
	...
	temporarily subsidize 75% of all upload costs. We expect the cost to stabilize as new miners enter the network and
	will discontinue subsidizing when the base cost drops.
</Callout>
