...
<Callout type="info" emoji="ℹ️">
	Due to a ~3.5x increase in the base cost to store on Arweave (arweave_cost) brought
	about by the 2.6 hardfork, we temporarily subsidize 75% of all upload costs. We expect
	the cost to stabilize as new miners enter the network and will discontinue subsidizing
	when the base cost drops.
</Callout>
