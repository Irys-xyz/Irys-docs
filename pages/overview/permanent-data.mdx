...
When you upload data you pay a single up-front fee. The upload fee is divided, with a portion used to pay miners to store the data while another portion goes into a storage endowment. The endowment is then used to keep the block reward for storing data higher than the cost of storage.
