...
<div className="flex flex-col mt-5">
	<div className="flex items-end">
    	<div className=""><Heading level={1}>Uploading / Bundling</Heading></div>
    </div>

    <p className="mt-4 text-xl">
    	Irys' uploading and bundling service makes adding permanent decentralized data with strong provenance to your dApp
    simple and seamless. All at scale.
    </p>
...
Irys' bundlers are highly scalable and [have been tested at over 50,000 transactions per second](https://www.youtube.com/watch?v=JKEivHKDXAo).
