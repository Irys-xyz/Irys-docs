...
The calculator provides the real-time cost of permanently uploading your data. Input a fixed amount of data, or add the files you plan to upload. For a more accurate estimate, include any [tags](/developer-docs/tags) you plan to use.
