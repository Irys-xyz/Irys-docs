...
This guide is an overview of what Lit Protocol is and how to use it with Irys. We also have code examples teaching how to do [server-side](./server-side-encryption) and [browser-based encryption](./browser-based-encryption).
...
- Encrypting posts for [Lens protocol](/tutorials/lens)
...
<img
	...
	src="/img/tutorials/encryption/irys-lit-encrypting.png"
/>
...
<img
	className="border border-[#FEF4EE] rounded mt-5 lg:w-5/6 w-full"
	src="/img/tutorials/encryption/irys-lit-decrypting.png"
/>
