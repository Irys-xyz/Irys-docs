...
Fund the [network](/overview/networks) you plan to upload to.
...
Irys supports adding any optional [metadata tags](/irys-sdk/tags) to each upload. When uploading files with a filename extension, the related [`Content-Type`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Type) (MIME type) tag is automatically added.
