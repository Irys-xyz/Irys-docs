...
To see the list of wallets for a given node, append `/info` to the node address. The list for `https://node2.irys.xyz/info` is:
...
<Callout type="info" emoji="ℹ️">
	For implementation and usage details, see the SDK documentation for [`fund()`](/developer-docs/irys-sdk/api/fund)
	and [`withdrawBalance()`](/developer-docs/irys-sdk/api/withdrawBalance)).
</Callout>
