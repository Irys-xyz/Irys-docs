...
To learn more, please refer to the <a className="underline text-blue-500" href="https://github.com/ArweaveTeam/arweave-standards/blob/master/ans/ANS-104.md" >spec documents.</a>
