...
sidebar_position: 3
title: Irys & Arweave
description: Irys helps scale Arweave helps reduce pain points experienced by devs. That's why we handle 90% of all traffic on Arweave.
---
...
In addition to easing developer pain points encountered when working with Arweave, Irys also adds [strong provenance](/overview/products/strong-provenance) to every upload.
