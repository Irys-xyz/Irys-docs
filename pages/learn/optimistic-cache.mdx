...
The optimistic cache ensures all data uploaded to Irys is immediately available via [gateways](/overview/gateways), which
are responsible for making data available to users.
