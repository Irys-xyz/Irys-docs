...
In addition to uploading using the SDK functions [`irys.upload()`](/irys-sdk/api/upload),[`irys.uploadFile()`](/irys-sdk/api/uploadFile),
and [`irys.uploadFolder()`](/irys-sdk/api/uploadFolder), you can also manually create, sign, and upload a transaction in separate steps.
