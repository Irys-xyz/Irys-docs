...
- [bigint: Failed to load bindings, pure JS will be used (try npm run rebuild?)](/irys-sdk/troubleshooting#bigint)
- [Error: Not enough balance for transaction](/irys-sdk/troubleshooting#insufficient-balance)
- [Error: Transaction simulation failed: Blockhash not found](/irys-sdk/troubleshooting#blockhash-not-found)
...
This error occurs when you try to upload to a bundler without first funding it. 
