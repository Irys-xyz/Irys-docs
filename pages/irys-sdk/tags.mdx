...
Tags are [indexed by gateways](/overview/gateways) and are queryable using the [Irys query package](/querying/query-package#tags) and [GraphQL](/querying/graphql#tags).
