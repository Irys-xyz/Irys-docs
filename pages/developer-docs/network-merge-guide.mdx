---
description: Irys is simplifying our developer experience by merging nodes 1 & 2.
---
...
Irys is simplifying our developer experience by merging nodes 1 & 2.

This means you will no longer need to:

- Choose a node when uploading to our mainnet
- Manage balances on separate mainnet nodes

**This change will go live on March 27th.**
