...
[Permanently](/overview/permanent-data) uploads a group of files (folder) in a single transaction.

This method is available in both our server SDK (`Irys`) and browser SDK (`WebIrys`) with different signatures.

-  [`Irys`](/developer-docs/irys-sdk/api/uploadFolder#irysuploadfolder)   
-  [`WebIry`](/developer-docs/irys-sdk/api/uploadFolder#webirysuploadfolder)
