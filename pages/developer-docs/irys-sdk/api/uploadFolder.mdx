...
[Permanently](/overview/permanent-data) uploads a folder. This function is supported with both server-side [`Irys`](/developer-docs/irys-sdk/api/uploadFolder#irysuploadfolder) class and browser-based [`WebIrys`](/developer-docs/irys-sdk/api/uploadFolder#webirysuploadfolder) class, however the signatures differ.
