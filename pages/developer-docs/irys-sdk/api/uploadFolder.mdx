...
- Server-SDK [`Irys`](/developer-docs/irys-sdk/api/uploadFolder#irysuploadfolder)   
- Browser-SDK [`WebIrys`](/developer-docs/irys-sdk/api/uploadFolder#webirysuploadfolder)
