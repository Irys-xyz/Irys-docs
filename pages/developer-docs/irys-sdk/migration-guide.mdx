...
*All* usage of `currency` in the SDK has been replaced with `token`, notably the argument as part of client instantiation (see [Constructor](migration-guide#constructor))
