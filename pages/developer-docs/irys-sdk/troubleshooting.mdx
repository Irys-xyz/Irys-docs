...
Most UNIX distributions come with Python installed. To install C++ build tools, the following works for most debian-based systems. For others, look at your package manager's "GCC build tools".
