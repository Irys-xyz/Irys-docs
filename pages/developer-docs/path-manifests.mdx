...
<img className="border border-[#FEF4EE] rounded mt-5 md:w-4/6 w-full" src="/img/irys-path-manifests.png" />

## Creating

To create a path manifest:

1. Create a JavaScript `Map` object where each entry maps a unique transaction ID to a unique path. Paths are arbitrary; you can use anything you want.
