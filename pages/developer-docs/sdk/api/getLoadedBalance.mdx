...
-   `loadedBalance`: Wallet balance on the connected node in atomic units. You can convert it into standard units using [`bundlr.utils.fromAtomic(atomicUnits)`](/developer-docs/sdk/api/utils-fromAtomic).
