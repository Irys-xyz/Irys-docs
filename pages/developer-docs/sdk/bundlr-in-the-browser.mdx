...
When building with Bundlr in the browser, we recommend starting by forking the [Bundlr provenance toolkit](/developer-docs/provenance-toolkit) and building your project using its rich UI component library and helper functions.
...
To manually add Bundlr support to an existing project, use the code snippets for your preferred provider.
