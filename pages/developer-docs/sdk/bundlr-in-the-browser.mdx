...
<Callout type="warning" emoji="⚠️">
	We recommend using ethers version 5 which our SDK fully supports. Ethers version 6 is not yet fully supported,
	however if your project does require it there are code options below which will work.
</Callout>
