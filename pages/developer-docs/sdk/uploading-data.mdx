...
The function `bundlr.upload(data)` uploads any data passed to it. The transaction id returned as part of the response is used to download the data, create a URL the format `https://arweave.net/[transaction_id]`.
