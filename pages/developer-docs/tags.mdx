...
Tags are indexed by gateways and are queryable using the [Irys query package](/developer-docs/querying/query-package#tags) and [GraphQL](/developer-docs/querying/graphql#tags).
