...
<img className="border border-[#FEF4EE] rounded mt-5 w-5/6" src="/img/graphql/IrysGQL-Anatomy.png" />
...
<img className="border border-[#FEF4EE] rounded mt-5 w-5/6" src="/img/graphql/IrysGQL-Sandbox.png" />
...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ids`        | An array of transaction IDs passed as strings. Values are ORed together, matching results will include transactions that have any of the supplied IDs.                                                                                                                                            |
| `owner`      | The Arweave address used when posting the transaction. Note if you post to Irys using a non-Arweave wallet address, it will be converted into an Arweave-like address and stored in this field. There is no way to retrieve eth or sol addresses from Arweave GraphQL, you must use Irys GraphQL. |
