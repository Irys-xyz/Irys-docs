...
This recipe guides you through building a provenance chain. If the topics of ["provenance"](terminology#data-provenance) and ["provenance chain"](/terminology#provenance-chain) are new to you, start with [Proof of Provenance](/overview/solutions/proof-of-provenance).
...
Start by [installing our SDK](/developer-docs/sdk/installing-the-sdk), setting up your imports, and creating a helper function that returns a reference to a configured Bundlr object.
