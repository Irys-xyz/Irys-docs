...
## [Install the CLI](/developer-docs/cli/installation)
...
## [Set Your Private Key](/developer-docs/cli/setting-private-key)

```console
bundlr -w myEthKeyPair.json -c ethereum
```

## [Fund Your Node](/developer-docs/cli/funding-a-node) (To Pay For Uploads)

```console
bundlr fund 1479016 -h https://node1.bundlr.network -w wallet.json -c ethereum
```

## [Upload A File](/developer-docs/cli/uploading-a-file)
