...
When funding and withdrawing using the functions [`irys.fund()`](/developer-docs/sdk/api/fund) or [`irys.withdrawBalance()`](/developer-docs/sdk/api/withdrawBalance), pass a value in atomic units.
