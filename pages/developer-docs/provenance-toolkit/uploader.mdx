...
If you don't choose to show the receipt, you can retrieve it later using the upload transaction id and the function [`bundlr.utils.getReceipt()`](/developer-docs/sdk/api/utils-getReceipt).
