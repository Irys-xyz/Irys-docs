---
title: SDK
description: Copy & Paste Code To Get You Started With Bundlr SDK
---
...
When [uploading a folder](/developer-docs/sdk/api/uploadFolder), files can be accessed either directly at `https://arweave.net/[transaction-id]` or `https://arweave.net/[manifest-id]/[file-name]`
