...
Queries return transaction metadata. To then retrieve data, use the returned transaction ID and download the data from a [gateway](/overview/gateways) using an URL formed as follows `https://arweave.net/[transaction-id]`.
