...
Transactions uploaded to Irys are queryable using both the Irys and [Arweave GraphQL schemas](https://gql-guide.vercel.app/). This document covers how to query Irys directly, Arweave [also has docs on their query schema](https://gql-guide.vercel.app/).
