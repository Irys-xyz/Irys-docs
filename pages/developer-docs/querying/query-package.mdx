...
The query package enables users to search Irys and Arweave transactions through an intuitive JavaScript interface. It is easily implemented in a few lines of code.	
