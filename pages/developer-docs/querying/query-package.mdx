...
The Irys query package is a JavaScript-based abstraction that sits on top of our GraphQL schema. It simplifies querying transaction metadata and is easily integrated into JavaScript-based projects with a few lines of code.
