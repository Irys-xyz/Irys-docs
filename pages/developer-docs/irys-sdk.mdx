...
Data uploaded to Irys is stamped with a millisecond-accurate timecode and attestation details before being passed to Arweave for permanent storage. This information is used to create a cryptographically signed [receipt](/learn/receipts) that is returned to the user upon successful upload.
