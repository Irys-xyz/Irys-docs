...
Change your `App.tsx` file as follows. This example uses ethers6, if you're using [a different provider](/developer-docs/irys-sdk/irys-in-the-browser#supported-providers) make sure to specify it when creating the `wallet`.
