...
This tutorial guides you through building a provenance chain. If the topics of [provenance](/terminology#data-provenance) and [provenance chain](/terminology#provenance-chain) are new to you, start with [strong provenance](/overview/products/strong-provenance).
