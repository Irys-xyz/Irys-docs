...
<Callout type="info" emoji="ℹ️">
	...
	browser, handles its encryption and decryption, and displays the decrypted file. When building your project, consider
	cloning the [Toolkit repository](https://github.com/Irys-xyz/provenance-toolkit) to use as a foundation.
</Callout>
