...
The quickest way to get started is to clone [our example repository](https://github.com/Irys-xyz/gassless-uploads) which supports gassless uploads from both EVM and Solana chains.
...
The [example app](hhttps://github.com/Irys-xyz/gassless-uploads) exposes three API routes, you can pick and choose which to use based on your own app design.
