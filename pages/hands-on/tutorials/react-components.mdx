	...
	return (
		<div className="px-10 py-5 flex flex-col" id="fund_container">
			...
			<div className="flex flex-row">
				...
				/>
				<button class="ml-5 bg-primary text-background font-bold py-1 px-3 rounded-lg" onClick={fundNode}>
					Fund
				</button>
			</div>
...
const ProgressBarUploader = () => {
	...
	return (
		<div className="flex flex-col py-5 ml-10">
			...
			<div class="mt-2 w-2/3 h-6 bg-gray-200 rounded-full dark:bg-gray-700" id="progress_bar_container">
				<div
