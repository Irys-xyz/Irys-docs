...
const token = "matic";
const bundlr = new Bundlr("http://devnet.bundlr.network", token, privateKey, {
...
You can also use the [Bundlr Provenance Toolkit repository](/developer-docs/provenance-toolkit) which provides a simple graphical interface.

1. Fork or clone the [repository](https://github.com/Bundlr-Network/provenance-toolkit)
