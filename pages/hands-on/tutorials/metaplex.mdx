...
<Callout type="info" emoji="ℹ️">
	[Irys was previously named Bundlr](https://irys.xyz/blog/bundlr-is-now-irys). At the time this tutorial was
...
<Callout type="info" emoji="ℹ️">
	Irys supports payment with [14 different tokens](/overview/supported-tokens), when using the Metaplex tools the
