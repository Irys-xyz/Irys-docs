...
This tutorial focuses on creating a SuperMon NFT that could evolve during gameplay. The NFT starts with a basic appearance and can be "upgraded" twice. We will use the [Irys CLI](/developer-docs/cli) to update the metadata, simulating the automatic changes that would occur through player interactions in an actual game.
...
<div className="flex flex-row gap-2">
	<img className="border border-[#FEF4EE] rounded-xl mt-5 w-1/3" src="/img/tutorials/dynamic-nft/image-level-1.png" />
	<img className="border border-[#FEF4EE] rounded-xl mt-5 w-1/3" src="/img/tutorials/dynamic-nft/image-level-2.png" />
	<img className="border border-[#FEF4EE] rounded-xl mt-5 w-1/3" src="/img/tutorials/dynamic-nft/image-level-3.png" />
</div>
...
<img className="border border-[#FEF4EE] rounded-xl mt-5 w-full" src="/img/tutorials/dynamic-nft/open-sea-mockup.jpg" />
