---
description: Using Lit Protocol to encrypt on-chain data with Irys and Arweave
---
...
<img className="border border-[#FEF4EE] rounded mt-5 w-full" src="/img/tutorials/encrypting/irys-lit-encrypting.png" />
...
<img className="border border-[#FEF4EE] rounded mt-5  w-full" src="/img/tutorials/encrypting/irys-lit-decrypting.png" />
