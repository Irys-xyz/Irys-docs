...
This recipe offers examples of how to monitor your balance using [JavaScript](/developer-docs/recipes/monitor-node-balance#javascript), our [Command Line Interface (CLI)](/developer-docs/recipes/monitor-node-balance#cli), and [cURL](/developer-docs/recipes/monitor-node-balance#curl). These techniques are all equally effective options for balance monitoring, choose the method that aligns with your unique architecture and requirements.
...
A third option is to make cURL request using an URL with the following format `https://<node-address>/account/balance/<currency>?address=<address>`. For example to check the Devnet MATIC balance of the wallet with address `0xaC568a981B1370B2e1bAA8cE30BD5AC9E28C572D`, you would use the command
`https://devnet.bundlr.network/account/balance/matic?address=0xaC568a981B1370B2e1bAA8cE30BD5AC9E28C572D`
