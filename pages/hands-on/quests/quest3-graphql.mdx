...
To have your wallet added to the Quest 3 whitelist, you need to get a perfect score on the quiz. If you’re not sure of a question, make sure to reach out to us on [Discord](https://discord.gg/4AsTuQ8pp9) and someone will help you out right away. Also, you can always check out our docs entry on [GraphQL](/developer-docs/graphql) and on [receipts](/learn/receipts).
