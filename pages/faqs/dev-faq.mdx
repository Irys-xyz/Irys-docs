...
You can do this using [JavaScript](/hands-on/tutorials/monitor-node-balance#javascript), our [CLI](/hands-on/tutorials/monitor-node-balance#cli), or [cURL](/hands-on/tutorials/monitor-node-balance#curl).
...
Bundlr and WebBundlr are fully compatible with React. However, if you are using npx create-react-app, you will need to do a few extra steps when setting up your project. We have [a fully detailed recipe here.](/hands-on/tutorials/react)
...
Yes. You can host static websites. We have [a detailed recipe on how to do it here.](/hands-on/tutorials/uploading-static-sites)
...
[Server-Side Signing](/hands-on/tutorials/gassless-uploading) is a method that allows you to sign and pay for your user’s data securely without exposing your private key. It allows you to add gassless transactions to your dApp.
