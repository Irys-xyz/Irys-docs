...
const CODE_SECTIONS: CodeSections = {
    1: (
        ...
        >
            ...
            <span className="text-[#79b8ff]">bundlr</span>{" "}
            <span className="text-[#eb707d]">= new</span>{" "}
            <span className="text-[#b392f0]">Bundlr</span>(
            <span className="text-[#44a447]">"https://node1.bundlr.network"</span>,{" "}
            <span className="text-[#44a447]">"matic"</span>,{" "}
    ...
    2: (
        ...
        >
            <span className="text-[#eb707d]">const</span>{" "}
            <span className="text-[#79b8ff]">response</span>{" "}
            <span className="text-[#eb707d]">= await</span>{" "}
            <span className="text-[#79b8ff]">bundlr</span>.
            <span className="text-[#b392f0]">fund</span>(fundAmount);
        </code>
    ),
    3: (
        <div
        ...
        >
            <span className="text-[#eb707d]">const</span>{" "}
            <span className="text-[#79b8ff]">dataToUpload</span>{" "}
            <span className="text-[#eb707d]">=</span>{" "}
            <span className="text-[#44a447]">"GM world."</span>;
            <br />
            <span className="text-[#eb707d]">const</span>{" "}
            <span className="text-[#79b8ff]">response</span>{" "}
            <span className="text-[#b392f0">= await</span>{" "}
            <span className="text-[#79b8ff]">bundlr</span>.
            <span className="text-[#b392f0]">upload</span>(dataToUpload);
        </div>
    ),
};
        ...
        <section className="flex flex-col gap-10">
            ...
            <ul className="flex flex-col gap-10 lg:gap-16">
                {items.map(({ id, title }) => (
                    <li
                        key={id}
                        className="flex flex-col items-center justify-center gap-2 md:items-start lg:gap-9"
                    >
                        <h2
                            className={`flex items-center gap-3 text-center text-3xl text-white md:text-left lg:text-5xl !cursor-pointer ${currentlyOpen !== id && "text-onyx hover:text-onyx/90"
                                }`}
