...
const FooterDesktop = ({
	...
	return (
		<>
			<footer
				className={`hidden items-start border-t border-timberwolf bg-seashell  font-backup font-satoshi antialiased xl:flex !text-black mt-10 ${
					noPadding ? "px-[24px]" : "px-[79px]"
				}`}
			>
